  ...
  hero: {
    ...
    directions: {
      visibility: {
        ...
        proof: [
          "Public Readiness — бесплатно, без платных AI-запросов",
          "ChatGPT · Gemini · Perplexity от $49/месяц",
          "Landscape, экспертная проверка и внедрение для более важных задач",
        ],
      },
      systems: {
